...
![diagram showing how it works](<?php echo Router::url('/img/diagrams/howitworks.svg'); ?>)
...
<figure>[![Passbolt Functional Overview](<?php echo Router::url('/img/diagrams/functional_overview.png');?>)](<?php echo Router::url('/img/diagrams/functional_overview.png');?>) </figure>
...
[![Creative Commons BY NC SA 4.0 logo](<?php echo Router::url('/img/third_party/by-sa.png');?>)](http://creativecommons.org/licenses/by-sa/4.0/) 

[![GNU AGPL v3.0 logo](<?php echo Router::url('/img/third_party/agplv3.png');?>)](http://www.gnu.org/licenses/agpl-3.0.en.html) 
...
<figure>![example of a security token](<?php echo Router::url('/img/screenshots/LU_security_token.png');?>) <span class="legend">fig. example of security token</span></figure>
...
[![Docker Logo](<?php echo Router::url('/img/third_party/docker_small_h.png');?>)](https://github.com/passbolt/passbolt_docker_debian) 
